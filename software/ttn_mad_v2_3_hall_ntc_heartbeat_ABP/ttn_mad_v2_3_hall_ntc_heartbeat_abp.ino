...
static const u4_t DEVADDR = FILLMEIN; // <-- Change this address for every node! (Formato 0xaabbccdd)
    ...
    */
    ...
    case EV_TXCOMPLETE:
      ...
      if (LMIC.dataLen) {
        ...
        //El downlink tendrá el formato canal (06), tipo de valor (00=digital), valor (0 o 100), FF
...
void do_send(osjob_t* j) {
  ...
  if (LMIC.opmode & OP_TXRXPEND) {
    ...
    lpp.addDigitalOutput(6, (digitalRead(4) ? 100 : 0));
