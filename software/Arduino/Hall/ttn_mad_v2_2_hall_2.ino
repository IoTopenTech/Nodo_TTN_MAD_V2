...
void loop() {
  ...
  if (puertaAbierta == digitalRead(3)) {
    ...
    Serial.print("Me voy a dormir hasta que se ");
    if (puertaAbierta == 1) {
      Serial.print( "cierre");
    } else {
      Serial.print( "abra");
    }
    Serial.println(" la puerta");
    delay(100);
    puertaAbierta=!puertaAbierta;//Si se despierta es porque la puerta ha cambiado de estado
